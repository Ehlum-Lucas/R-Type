...
void Menu::EventKey()
{
    if (_event.type == sf::Event::KeyPressed) {
        if (_event.key.code == sf::Keyboard::Escape) {
            ...
            if (_event.key.code == sf::Keyboard::BackSpace && !_inputIp.empty() && _isFocusedIp == true) {
                _inputIp.pop_back();
            ...
            if (_event.key.code == sf::Keyboard::BackSpace && !_inputPort.empty() && _isFocusedPort == true) {
                _inputPort.pop_back();
...
void Menu::EventTextEntered()
{
    if (_event.type == sf::Event::TextEntered && (_isFocusedIp == true || _isFocusedPort == true)) {
        if (_event.text.unicode < 128 && _event.text.unicode != 8 && _isFocusedIp == true) {
        ...
        if (_event.text.unicode < 128 && _event.text.unicode != 8 && _isFocusedPort == true) {
...
void Menu::EventMouse()
{
    sf::Vector2f mousePos = _window->mapPixelToCoords(sf::Mouse::getPosition(*_window.get()));
